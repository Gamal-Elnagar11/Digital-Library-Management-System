...
namespace BookShopping_MVC.Repositories
{
    public class CartRepository : ICartRepository
    {
        ...
        public  async Task<int> GetCartItemCount(string userId = "")
        {
            ...
            //            where cart.UserId == userId  // update line
        ...
        public async Task<bool> DoCheck(CheckoutModel model)
        {
            ...
            // throw new exception --> use with transaction
            // return any thing  --> use with validation 

            try
            {
                // logic 
                // move data from cartDetail to order detail we will remove cart detail 
                var userId = GetUserId();
                if (string.IsNullOrEmpty(userId))
                ...
                var pendingRecord = _db.ordersStatus.FirstOrDefault
                ...
                var order = new Order
                {
                    ...
                    IsPaid = false,
                    OrderStatusId = pendingRecord.Id  // pendding
                };
                ...
                foreach (var item in cartDetail)
                {
                    ...
                    var stock = await _db.Stock.FirstOrDefaultAsync(a =>
             ...
             //   _db.SaveChanges();
                ...
                // after add order detail and savechanges will remove cartdetail (cart will by empty)
